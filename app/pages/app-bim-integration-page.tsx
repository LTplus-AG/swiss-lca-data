...
export function Page() {
  ...
  const [selectedFields, setSelectedFields] = useState<string[]>(['id', 'name', 'group'])
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <Alert className="mb-6">
        ...
        <AlertDescription>
          Ensure your BIM software is compatible with the KBOB data structure before proceeding with the integration.
        </AlertDescription>
      </Alert>
        ...
        <TabsContent value="mapping">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Define how KBOB data fields map to your BIM software</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="mb-4">
                <Label htmlFor="fieldSelect" className="mb-2 block">Select Fields</Label>
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="outline" className="w-full justify-between">
                      {selectedFields.length > 0 ? `${selectedFields.length} fields selected` : "Select fields"}
              ...
              <div className="grid gap-4">
                {selectedFields.map((field) => (
                  <div key={field} className="grid grid-cols-3 items-center gap-4">
                    <Label htmlFor={field}>{availableFields.find(f => f.value === field)?.label}</Label>
                    <Input
                      id={field}
                    ...
                    />
                    <Button variant="outline" size="icon" onClick={() => handleRemoveMapping(field)}>
                      <X className="h-4 w-4" />
                    </Button>
                  </div>
                ))}
        ...
        <TabsContent value="materials">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Choose materials to include in the BIM export</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
        ...
        <TabsContent value="export">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure and initiate the BIM data export</CardDescription>
            </CardHeader>
            <CardContent>
      ...
      <Card className="mt-8">
        <CardHeader>
          ...
          <CardDescription>Load a previously saved BIM integration configuration</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex items-center space-x-2">
